"""
This file "samplebase.py" is made by  hzeller.
https://github.com/hzeller/rpi-rgb-led-matrix/blob/master/bindings/python/samples/samplebase.py
Commit"36a4633"
https://github.com/hzeller/rpi-rgb-led-matrix/commit/36a46331e300764a79a4ba45d723270e8cceedda
"""
...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--led-slowdown-gpio", action="store",
                                 help="Slow down writing to GPIO. Range: 1..100. Default: 1", choices=range(3), type=int)
